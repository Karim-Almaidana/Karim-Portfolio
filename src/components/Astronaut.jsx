...
const ASTRONAUT_MODEL_PATH = `${import.meta.env.BASE_URL}models/tenhun_falling_spaceman_fanart.glb`;

export function Astronaut(props) {
  const group = useRef(null);

  const { nodes, materials, animations } = useGLTF(ASTRONAUT_MODEL_PATH);
